...
public class Cat_HitState : EnemyState
{
    protected Enemy enemy;
    private bool isGrounded;

    public Cat_HitState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        enemy = _enemyBase;
    }
